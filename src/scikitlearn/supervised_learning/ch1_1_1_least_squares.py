...
When features are correlated and the columns of the design matrix X have an approximate linear
...
O(n_samples X n_features^2), assuming that n_samples ≥ n_features.
