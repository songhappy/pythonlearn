...
for learning_rate in [0.1]:
    for max_depth in [14]:
        for num_iterations in [10000]:
            ...
            evaluator = BinaryClassificationEvaluator(labelCol="Bankrupt?", rawPredictionCol="rawPrediction")
            auc = evaluator.evaluate(predictions, {evaluator.metricName: "areaUnderROC"})

            evaluator2 = MulticlassClassificationEvaluator(labelCol="Bankrupt?", predictionCol="prediction")
